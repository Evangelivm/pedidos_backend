// filepath: d:\recuperacion\pedidos_backend\src\productos\pipes\coercive-producto.pipe.ts
import { PipeTransform, Injectable, BadRequestException } from '@nestjs/common';
import { z } from 'zod';

@Injectable()
export class CoerciveProductoPipe implements PipeTransform {
  constructor(private schema: z.Schema) {}

  transform(value: any) {
    console.log('Datos recibidos en el Pipe:', value); // Agrega este log
